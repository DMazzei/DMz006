...
import org.dmz.studio.conn.response.*;
import org.dmz.studio.conn.response.data.*;
import org.dmz.studio.conn.response.data.character.*;
...
public enum RequestType {
    ...
    DATA_CHARACTER_ACHIEVEMENTS("wow/data/character/achievements", org.dmz.studio.conn.response.data.character.Achievements.class),
    DATA_GUILD_REWARDS("wow/data/guild/rewards", Rewards.class),
    DATA_GUILD_PERKS("wow/data/guild/perks", Perks.class),
    DATA_GUILD_ACHIEVEMENTS("wow/data/guild/achievements", org.dmz.studio.conn.response.data.guild.Achievements.class),
    DATA_ITEM_CLASSES("wow/data/item/classes", org.dmz.studio.conn.response.data.item.Classes.class),
